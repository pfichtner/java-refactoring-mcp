...
```
refactor-mcp/target/refactor-mcp-0.1.2-fat.jar
```
...
```bash
claude mcp add java-refactoring -- java -jar /absolute/path/to/refactor-mcp-0.1.2-fat.jar
```
...
```json
{
  "mcpServers": {
    "java-refactoring": {
      "command": "java",
      "args": ["-jar", "/absolute/path/to/refactor-mcp-0.1.2-fat.jar"]
    }
  }
}
```
